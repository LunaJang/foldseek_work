...
LocalParameters::LocalParameters() :
        ...
        PARAM_VIEW_RESULTS(PARAM_VIEW_RESULTS_ID, "--view-structty", "View results with StrucTTY", "Launch StrucTTY viewer after result generation (requires StrucTTY in PATH)", typeid(bool), (void *) &viewResults, "")
        {
